...
export const Navbar: React.FC = () => {
  ...
  return (
    <nav className={cn(
      "fixed top-2 left-4 right-4 z-50 h-16 transition-all duration-500 flex items-center px-6 md:px-10 rounded-2xl",
      "bg-transparent border border-transparent",
      "hover:bg-black/30 hover:backdrop-blur-xl hover:border-white/5 hover:shadow-2xl"
    )}>
